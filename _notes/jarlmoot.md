...
La prueba no debería ser “matar cosas”, sino aceptar la muerte.

Idea: El Salón de los Caídos

Los jugadores atraviesan una sala donde aparecen personas que no pudieron salvar:

NPCs muertos
familiares
compañeros caídos
versiones alternativas de sí mismos

Un espectro gigante les hace preguntas:

“¿A quién dejarías morir para salvar al resto?”

Mecánica:

deben sacrificar algo:
puntos de vida máximos temporales
recuerdos
un objeto mágico
...
los enemigos reviven infinitamente
la sala no puede resolverse por fuerza
Variante

Un puente sobre un abismo helado:

solo puede cruzar quien acepte caer
los que “se lanzan” despiertan al otro lado
FJELL — Mountain

Mountain

Representa resistencia, paciencia y perseverancia.
...
No hay monstruos casi.

El reto es:

administrar recursos
cargar con peso
decidir quién ayuda a quién
...
Cuanto más rápido intenten subir:

más difícil se vuelve

La montaña “rechaza” la impaciencia.

KRIG — War

War

Aquí sí puede haber combate, pero con una enseñanza.

Idea: La Batalla Eterna

Los jugadores aparecen en medio de una guerra gigante antigua.

Dos bandos:

ninguno es completamente bueno
...
el campo nunca termina

La solución puede ser:

destruir el cuerno de guerra
convencer líderes
sacrificar ventaja táctica
rendirse
Otra versión

Cada vez que matan:

aparece otro enemigo más fuerte

La guerra se alimenta de la violencia.

LIV — Life

Life

La más rara y probablemente la más emocional.

Idea: El Jardín Bajo el Hielo

Una caverna cálida y viva bajo la tundra.

Aquí:

las armas pesan
el fuego calma
criaturas pequeñas ayudan

El reto:

proteger algo frágil

Ejemplos:

un brote del Árbol del Mundo
un bebé remorhaz
espíritus animales
almas reencarnándose

La prueba termina cuando:

el grupo prioriza proteger antes que ganar
Mecánica bonita

Los hechizos destructivos dañan el entorno:

si destruyen demasiado, fallan
VIND — Wind

Wind

Representa libertad, adaptación y cambio.

Idea: El Laberinto de las Voces

Una zona donde:

los pasillos cambian
las puertas se mueven
las corrientes arrastran

No puede mapearse de forma normal.
...
Cuanto más intenten controlar el camino:

más se pierde la dungeon

La solución requiere improvisar.

Variante

Una sala con plataformas flotantes movidas por corrientes de aire gigantes.

WYRM — Dragon

Dragon

No tiene por qué ser literalmente un dragón.
...
orgullo
legado
Idea: La Cámara del Tesoro

Una montaña inmensa de tesoros.

Cada jugador ve:

el objeto que más desea

Si lo toman:

el dungeon los “marca”
aparece corrupción dracónica
el brasero no se activa

La prueba consiste en:

renunciar al poder
Alternativa más épica

Un dragón dormido gigantesco.

Para pasar:

deben cruzar sin despertarlo
pero el dragón habla telepáticamente
ofrece pactos personalizados
Idea MUY potente para el final

Cuando encienden los 6 braseros:

las llamas forman una runa gigante
aparece un antiguo jarl espectral
revela que las pruebas no eran para abrir una puerta…

…sino para decidir si el grupo merece romper el ciclo de Thruun/Hjoölvir.

Y el jarl puede juzgarlos según CÓMO resolvieron cada prueba:
